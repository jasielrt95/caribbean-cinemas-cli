// Package caribbeancinemas is an unofficial, read-only Go client for the
// Caribbean Cinemas (Puerto Rico) GraphQL API, which runs on the INDY Cinema
// Group / Fandango platform. This community-built project is not affiliated
// with, maintained by, or endorsed by Caribbean Cinemas.
//
